...
class ItemTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item_type" do
    assert_difference('ItemType.count') do
      post item_types_url, params: { item_type: { days_until_expiration: @item_type.days_until_expiration, description: @item_type.description, name: @item_type.name } }
    end
  ...
  test "should update item_type" do
    patch item_type_url(@item_type), params: { item_type: { days_until_expiration: @item_type.days_until_expiration, description: @item_type.description, name: @item_type.name } }
